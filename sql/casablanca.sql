...
( 4, 4,"オデッセイ","おでっせい","宇宙飛行士の映画です。",3,1000,"./images","DVDimage1.jpg",now(),"ふぉっくす",0,now(),now()),
( 5, 5,"スターウォーズ","すたーうぉーず","とてもゆうめいでおもしろい映画です。",3,2000,"./images","DVDimage2.jpg",now(),"るーかすふぃるむ",0,now(),now()),
( 6, 6,"シンゴジラ","しんごじら","ごじらの最新作です。",3,2500,"./images","DVDimage3.jpg",now(),"とーほー",0,now(),now()),
( 7, 7,"スマッシュブラザーズ","すまっしゅぶらざーず","シリーズ全作おもしろいゲームです。",4,4000,"./images","gameimage1.jpg",now(),"にんてんどー",0,now(),now()),
( 8, 8,"女神転生","めがみてんせい","20年以上続く歴史あるゲームです。",4,3500,"./images","gameimage2.jpg",now(),"あとらす",0,now(),now()),
( 9, 9,"ポケモン不思議のダンジョン","ぽけもんふしぎのだんじょん","ポケモンが主人公のゲームです。",4,3000,"./images","gameimage3.jpg",now(),"にんてんどー",0,now(),now());
