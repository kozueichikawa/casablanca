...
( 1, 1,"ぶっ生き返す","ぶっいきかえす","「まきしまむざほるもん」のアルバムです。",2,3500,"./images","CDimage1.jpg","2005/03/02","ばっぷ",0,now(),now()),
( 2, 2,"ソルファ","そるふぁ","「あじあんかんふーじぇねれーしょん」のアルバムです。",2,3000,"./images","CDimage2.jpg","2004/10/20","きゅーんれこーど",0,now(),now()),
( 3, 3,"無罪モラトリアム","むざいもらとりあむ","「しいなりんご」のアルバムです。",2,3200,"./images","CDimage3.jpg","1999/02/24","ゆにばーさる",0,now(),now()),
( 4, 4,"女々しくて","めめしくて","「ごーるでんぼんばー」のシングルです。",2,1000,"./images","CDimage4.jpg","2009/10/21","ざにーざっぷ",0,now(),now()),
( 5, 5,"オデッセイ","おでっせい","宇宙飛行士の映画です。",3,1000,"./images","DVDimage1.jpg","2016/02/05","ふぉっくす",0,now(),now()),
( 6, 6,"スターウォーズ","すたーうぉーず","とてもゆうめいな映画です。",3,2000,"./images","DVDimage2.jpg","2015/12/18","るーかすふぃるむ",0,now(),now()),
( 7, 7,"シンゴジラ","しんごじら","ごじらの最新作です。",3,2500,"./images","DVDimage3.jpg","2016/07/29","とーほー",0,now(),now()),
( 8, 8,"陽だまりの彼女","ひだまりのかのじょ","まつじゅんがでています。",3,2500,"./images","DVDimage4.jpg","2013/07/29","とーほー",0,now(),now()),
( 9, 9,"スマッシュブラザーズ","すまっしゅぶらざーず","シリーズ全作おもしろいゲームです。",4,4000,"./images","gameimage1.jpg","2014/09/13","にんてんどー",0,now(),now()),
( 10, 10,"女神転生","めがみてんせい","20年以上続く歴史あるゲームです。",4,3500,"./images","gameimage2.jpg","1992/10/30","あとらす",0,now(),now()),
( 11, 11,"ポケモン不思議のダンジョン","ぽけもんふしぎのだんじょん","ポケモンが主人公のゲームです。",4,3000,"./images","gameimage3.jpg","2015/09/17","にんてんどー",0,now(),now()),
( 12, 12,"星のカービィ","ほしのかーびぃ","オムニバス形式のゲームです。",4,3500,"./images","gameimage4.jpg","2008/09/29","にんてんどー",0,now(),now());


insert into destination_info values
(1,"guest","インターノウス","テストユーざー","いんたーのうす","てすとゆーざー","guest@internous.co.jp","080-1234-5678","東京都千代田区三番町１ー１　ＫＹ三番町ビル１Ｆ",now(),"0001-01-01 00:00:00");
