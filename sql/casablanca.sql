...
( 6, 6,"シンゴジラ","しんごじら","ごじらの最新作です。",2,2500,"./images","DVDimage3.jpg",now(),"とーほー",0,now(),now()),
( 7, 7,"スマッシュブラザーズ","すまっしゅぶらざーず","シリーズ全作おもしろいゲームです。",2,4000,"./images","gameimage1.jpg",now(),"にんてんどー",0,now(),now()),
( 8, 8,"女神転生","めがみてんせい","20年以上続く歴史あるゲームです。",2,3500,"./images","gameimage2.jpg",now(),"あとらす",0,now(),now()),
( 9, 9,"ポケモン不思議のダンジョン","ぽけもんふしぎのだんじょん","ポケモンが主人公のゲームです。",2,3000,"./images","gameimage3.jpg",now(),"にんてんどー",0,now(),now());
